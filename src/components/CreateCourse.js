...
const CreateCourse = (props) => {
  ...
  const createCourse = () => {
    ...
    Axios.post("https://major-backend.onrender.com/api/course", courseObject, {
      header: {
  ...
  const joinCourse = () => {
    ...
    Axios.post("https://major-backend.onrender.com/api/checkCourse", codeObject, {
      header: {
        "Content-Type": "application/json; charset=utf-8",
      },
    })
      .then((res) => {
        if (res.data.success) {
          ...
          Axios.post("https://major-backend.onrender.com/api/records", recordObject, {
            header: {
              "Content-Type": "application/json; charset=utf-8",
            },
          })
