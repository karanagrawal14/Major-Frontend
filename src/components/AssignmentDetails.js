...
const AssignmentDetails = () => {
  ...
  React.useEffect(() => {
    Axios.get(`https://major-backend.onrender.com/api/assignment/${assignmentID}`)
      .then((res) => {
        ...
        Axios.get(`https://major-backend.onrender.com/api/${course_id}`)
          .then((res) => {
  ...
  React.useEffect(() => {
    ...
    Axios.get(`https://major-backend.onrender.com/api/marks/${assignmentID}`)
      .then((res) => {
        ...
        Axios.get(`https://major-backend.onrender.com/api/assignment/students/${assignmentID}`)
          .then((res) => {
  ...
  const sendMarks = () => {
    ...
    Axios.post(
      `https://major-backend.onrender.com/api/submission/grade/${assignmentID}/${currentStudent.student_id}`,
      {
        marks: marks,
      }
    )
  ...
  const submitAssignment = () => {
    ...
    Axios.post(`https://major-backend.onrender.com/api/submission`, {
      assignment_id: assignmentID,
      student_id: user._id,
    })
      .then((res) => {
        Axios.post(
          `https://major-backend.onrender.com/api/submission/attachment/${res.data.data._id}`,
          formData,
          {
            headers: {
  ...
  const checkAttachment = () => {
    Axios.get(`https://major-backend.onrender.com/api/hasAttachment/${assignmentID}`)
      .then((res) => {
        if (res.data.success) {
  ...
  const checkHasSubmitted = () => {
    Axios.get(`https://major-backend.onrender.com/api/hasSubmitted/${assignmentID}/${user._id}`)
      .then((res) => {
        ...
        >
          ...
          {hasAttachment === true ? (
            <reactFragment>
              <br />
              <a
                href={`https://major-backend.onrender.com/api/assignment/attachment/${assignmentID}`}
                target="_blank"
              >
                <button
                  className="btn btn-new"
                  ...
                  {studentSubmissions.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <a
                            href={`https://major-backend.onrender.com/api/submission/getAttachment/${assignmentID}/${item.student_id}`}
                            target="_blank"
                          >
                            <Download
                              size={20}
